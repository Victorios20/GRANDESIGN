...
import {
  integrarPedidosCompraAoFinanceiro,
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const data = await integrarPedidosCompraAoFinanceiro(ids, actorId)
    ...
    console.error("[POST /api/pedido_compra/integrar/bulk] unexpected", error)
