...
export const SUPPLIER_NAME_OVERRIDES: Record<string, string> = {
  ...
  rede: "Rede",
  "shopping da madeira": "Shopping da Madeira",
  sotero: "Sotero",
  "stain para obras": "Stain para Obras",
  "telha azul": "Telha Azul",
  uber: "Uber",
  "vem ki tem": "Vem Ki Tem",
...
export const SUBCATEGORY_OVERRIDE_BY_ROW_KEY: Record<string, string> = {}

export const TRANSFER_DESTINATION_BY_ROW_KEY: Record<string, string> = {}
